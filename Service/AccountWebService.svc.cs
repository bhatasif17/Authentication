...
namespace Service
{
    public class AccountWebService : IAccountWebService
    {
        ...
        public AccountWebService(IRepository<Account> accountRepository, ApplicationUserManager userManager, IStudentRepository studentRepository)
        {
        ...
        void IAccountWebService.CreateStudent(Student student)
        {
            _studentRepository.Create(student);
        }

        public List<Student> GetAllStudentsByUsername(string UserID)
        {
            return _studentRepository.GetAll(UserID);
        }
    }
}
